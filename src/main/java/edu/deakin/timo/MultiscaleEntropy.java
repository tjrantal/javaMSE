...
/**
	...
	Ported from C to java by Timo Rantalainen 2014 tjrantal at gmail dot com
	The C source written by M Costa 2004 copied from http://physionet.org/physiotools/mse/
...
public class MultiscaleEntropy extends BaseClass{
	...
	/**Constructor
		@param	dataIn	Sarray for which the MSE is to be calculated
		@param	r		tolerance (maximum distance, will be multiplied with dataIn SD)
		@param	tau		the maximum length of the mean for the coarse-grained time series. Series with coarseness from 1 to tau will be created		
		@param	mMax	the maximum m to calculate SE for. SEs from 1 to mMax will be calculated
	*/
	...
	*/
	...
	public class SERunnable implements Runnable{
		...
		/**Constructor
			...
			@param	r		tolerance (maximum distance, will be multiplied by se)
